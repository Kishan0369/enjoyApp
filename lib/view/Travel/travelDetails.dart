...
import 'package:enjoy/view/Travel/travel_review_photo.dart';
...
class TravelDetailsScreen extends StatelessWidget {
  final TarvelItem item;

  TravelDetailsScreen({required this.item});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Travel Location',style: GoogleFonts.josefinSans(
              ...
              child: Card(
                ...
                child: SizedBox(
                  child: ListTile(
                    ...
                    onTap: () {
                      Get.to(() => TravelInfo(item: item)); // Navigate to ItemDetailsScreen
                    },
