...
import 'gift_review_photo.dart';



class GifftDetailsScreen extends StatelessWidget {
  final Item item;

  GifftDetailsScreen({required this.item});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Gifts Location',style: GoogleFonts.josefinSans(
              ...
              child: Card(
                ...
                child: SizedBox(
                  child: ListTile(
                    ...
                    onTap: () {
                      Get.to(() => GiftInfo(item: item)); // Navigate to ItemDetailsScreen
                    },
